...
use Ketan4373\RestAPI\Tests\TestCase;
...
class DummyUserTest extends TestCase
{
    ...
    public function testUserIndexWithFilters()
    {
        ...
        $userId = $createFactory->of(\Ketan4373\RestAPI\Tests\Models\DummyUser::class)->create();
    ...
    {
        $user = \Ketan4373\RestAPI\Tests\Models\DummyUser::all()->random();
    ...
    public function testShowCommentsByUserRelationsEndpoint()
    {
        ...
        $post = \Ketan4373\RestAPI\Tests\Models\DummyPost::all()->random();

        $createFactory = \Illuminate\Database\Eloquent\Factory::construct(\Faker\Factory::create(),
            base_path() . '/laravel-rest-api/tests/Factories');

        $comment = $createFactory->of(\Ketan4373\RestAPI\Tests\Models\DummyComment::class)->create([
    ...
    public function testShowPostsByUserRelationsEndpoint()
    {
        ...
        $createFactory->of(\Ketan4373\RestAPI\Tests\Models\DummyPost::class)->create([
            'post' => "dummy POst",
            'user_id' => $user->id,
        ]);
