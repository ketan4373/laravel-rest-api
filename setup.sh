...
#    git checkout 5.2
    ...
    php -r "
        ...
        \$arr[\"autoload\"][\"psr-4\"][\"Ketan4373\\\\RestAPI\\\\\"] = \"laravel-rest-api/src\";
        \$arr[\"autoload\"][\"psr-4\"][\"Ketan4373\\\\RestAPI\\\\Tests\\\\\"] = \"laravel-rest-api/tests\";
...
git clone https://github.com/Ketan4373/laravel-rest-api
git checkout master
composer du
cd .. || exit